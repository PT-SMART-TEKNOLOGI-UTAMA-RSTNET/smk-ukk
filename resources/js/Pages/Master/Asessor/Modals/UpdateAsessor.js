...
export default class UpdateAsessor extends React.Component{
    constructor(props){
        super(props);
        this.state = {
            form : {
                _method : 'patch', id : '', nama_asessor : '', jenis_asessor : pengujiTypeOptions[0], email_asessor : '',
        ...
        this.submitUpdateAsessor = this.submitUpdateAsessor.bind(this);
    ...
    componentWillReceiveProps(props){
        if (props.data !== null) {
            ...
            form.id = props.data.value,
                form.nama_asessor = props.data.label,
                form.email_asessor = props.data.meta.email,
                form.jenis_asessor = pengujiTypeOptions[pengujiTypeOptions.findIndex((i) => i.value === props.data.meta.penguji.type)];
            this.setState({form});
        }
    }
    ...
    render(){
        return (
            <Dialog
                ...
                onClose={()=>this.state.button.submit.disabled ? null : this.props.handleClose('update')}
                scroll="body">
                <form onSubmit={this.submitUpdateAsessor}>
                    ...
                    <DialogContent dividers={true}>
                        ...
                        <div className="form-group row">
                            ...
                            <div className="col-md-4">
                                ...
                                <small className="text-sm text-muted">Kosongkan jika tidak ingin merubah kata sandi</small>
                            </div>
                        </div>
                        <div className="form-group row">
                    ...
                    <DialogActions>
                        ...
                        <button onClick={()=>this.state.button.submit.disabled ? null : this.props.handleClose('update') } disabled={this.state.button.submit.disabled} type="button" className="btn btn-secondary"><i className="fas fa-times"/> Tutup</button>
                    </DialogActions>
                </form>
            </Dialog>
        );
